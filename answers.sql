...
SELECT models.name, brand_name, headquarters FROM brands, models WHERE models.name='Mustang' AND brand_name='Ford' AND headquarters='Dearborn, MI';
...
SELECT * FROM brands WHERE founded < 1903 ORDER BY founded ASC;
